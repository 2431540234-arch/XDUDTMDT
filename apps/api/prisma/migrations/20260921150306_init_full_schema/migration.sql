...
-- CreateEnum
CREATE TYPE "ModelFormat" AS ENUM ('GLB', 'USDZ');
...
-- CreateIndex
CREATE INDEX "Product3DModel_variantId_idx" ON "Product3DModel"("variantId");
...
-- AddForeignKey
ALTER TABLE "Product3DModel" ADD CONSTRAINT "Product3DModel_variantId_fkey" FOREIGN KEY ("variantId") REFERENCES "ProductVariant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
